...
public class Level_9 extends JFrame
{
	/**
	 * This is the class contains the ninth level of the program
	 */
	...
	private ObstacleObject2Wide obs11, obs12, obs13, obs14, obs15, obs16, obs17, obs18, obs19, obs20, obs21, obs22, obs23, obs24;
	private ObstacleObject2Long obs25, obs26, obs27, obs28;
	private ObstacleObject3Wide obs29, obs30, obs31, obs32, obs33, obs34, obs35, obs36, obs37, obs38, obs39, obs40, obs41, obs42;
	private ObstacleObject3Long obs43, obs44;
	private ObstacleObject4Wide obs45, obs46, obs47, obs48, obs49, obs50, obs51;
	private ObstacleObject4Long obs52, obs53, obs54, obs55, obs56, obs57, obs58, obs59, obs60;
	private ObstacleObject14Wide obs61, obs62, obs63, obs64;
	private ObstacleObject17Long obs65;
	...
	public Level_9( final int charNum, final int score1 )
	{	
		super( "Perplexia - Wide Maps: Level 3 (Beach)" );
		saveFile = new ReadSaveFile();
		panel = new EasyPanel( 9 );
		char1 = charNum;
		...
		newItem.addActionListener(
			new ActionListener()
			{
				public void actionPerformed( ActionEvent event )
				{
					...
					option = JOptionPane.showOptionDialog( Level_9.this, 
		...
		howItem.addActionListener(
			new ActionListener()
			{
				...
				{
					timer1.stop();
					JOptionPane.showMessageDialog( Level_9.this,
		...
		player1 = new CharacterControl( 4, 288, KeyEvent.VK_DOWN, panel, char1 );
		panel.add( player1 );
		
		obsEnd = new ObstacleObject( 636, 0, panel, "images", 12 );
		
		player1.keyPressed( KeyEvent.VK_DOWN + KeyEvent.VK_UP );
		player1.keyPressed( KeyEvent.VK_DOWN + KeyEvent.VK_UP );
		
		obs1 = new ObstacleObjectSingle( 0, 223, panel );
		obs2 = new ObstacleObjectSingle( 0, 351, panel );
		obs3 = new ObstacleObjectSingle( 32, 256, panel );
		obs4 = new ObstacleObjectSingle( 32, 320, panel );
		obs5 = new ObstacleObjectSingle( 32, 415, panel );
		obs6 = new ObstacleObjectSingle( 128, 383, panel );
		obs7 = new ObstacleObjectSingle( 383, 192, panel );
		obs8 = new ObstacleObjectSingle( 479, 256, panel );
		obs9 = new ObstacleObjectSingle( 705, 64, panel );
		obs10 = new ObstacleObjectSingle( 895, 447, panel );
		
		obs11 = new ObstacleObject2Wide( 160, 415, panel );
		obs12 = new ObstacleObject2Wide( 288, 160, panel );
		obs13 = new ObstacleObject2Wide( 415, 288, panel );
		obs14 = new ObstacleObject2Wide( 415, 320, panel );
		obs15 = new ObstacleObject2Wide( 447, 192, panel );
		obs16 = new ObstacleObject2Wide( 511, 288, panel );
		obs17 = new ObstacleObject2Wide( 511, 320, panel );
		obs18 = new ObstacleObject2Wide( 607, 256, panel );
		obs19 = new ObstacleObject2Wide( 607, 288, panel );
		obs20 = new ObstacleObject2Wide( 607, 320, panel );
		obs21 = new ObstacleObject2Wide( 641, 95, panel );
		obs22 = new ObstacleObject2Wide( 705, 256, panel );
		obs23 = new ObstacleObject2Wide( 769, 288, panel );
		obs24 = new ObstacleObject2Wide( 769, 320, panel );
		
		obs25 = new ObstacleObject2Long( 64, 383, panel );
		obs26 = new ObstacleObject2Long( 223, 320, panel );
		obs27 = new ObstacleObject2Long( 607, 192, panel );
		obs28 = new ObstacleObject2Long( 705, 288, panel );
		
		obs29 = new ObstacleObject3Wide( 192, 95, panel );
		obs30 = new ObstacleObject3Wide( 192, 128, panel );
		obs31 = new ObstacleObject3Wide( 288, 223, panel );
		obs32 = new ObstacleObject3Wide( 288, 256, panel );
		obs33 = new ObstacleObject3Wide( 288, 288, panel );
		obs34 = new ObstacleObject3Wide( 288, 320, panel );
		obs35 = new ObstacleObject3Wide( 415, 223, panel );
		obs36 = new ObstacleObject3Wide( 447, 95, panel );
		obs37 = new ObstacleObject3Wide( 447, 128, panel );
		obs38 = new ObstacleObject3Wide( 575, 32, panel );
		obs39 = new ObstacleObject3Wide( 673, 192, panel );
		obs40 = new ObstacleObject3Wide( 673, 223, panel );
		obs41 = new ObstacleObject3Wide( 800, 383, panel );
		obs42 = new ObstacleObject3Wide( 832, 32, panel );
		
		obs43 = new ObstacleObject3Long( 32, 95, panel );
		obs44 = new ObstacleObject3Long( 543, 192, panel );
		
		obs45 = new ObstacleObject4Wide( 320, 95, panel );
		obs46 = new ObstacleObject4Wide( 320, 128, panel );
		obs47 = new ObstacleObject4Wide( 447, 32, panel );
		obs48 = new ObstacleObject4Wide( 641, 128, panel );
		obs49 = new ObstacleObject4Wide( 673, 383, panel );
		obs50 = new ObstacleObject4Wide( 705, 32, panel );
		obs51 = new ObstacleObject4Wide( 769, 95, panel );
		
		obs52 = new ObstacleObject4Long( 64, 95, panel );
		obs53 = new ObstacleObject4Long( 95, 223, panel );
		obs54 = new ObstacleObject4Long( 128, 95, panel );
		obs55 = new ObstacleObject4Long( 160, 223, panel );
		obs56 = new ObstacleObject4Long( 223, 192, panel );
		obs57 = new ObstacleObject4Long( 575, 64, panel );
		obs58 = new ObstacleObject4Long( 800, 160, panel );
		obs59 = new ObstacleObject4Long( 863, 128, panel );
		obs60 = new ObstacleObject4Long( 863, 256, panel );
		
		obs61 = new ObstacleObject14Wide( 0, 32, panel );
		obs62 = new ObstacleObject14Wide( 0, 447, panel );
		obs63 = new ObstacleObject14Wide( 223, 383, panel );
		obs64 = new ObstacleObject14Wide( 447, 447, panel );
		
		obs65 = new ObstacleObject17Long( 927, 0, panel );
		...
		panel.add( obs20 ); panel.add( obs43 ); panel.add( obs21 ); 
		panel.add( obs44 ); panel.add( obs22 ); panel.add( obs45 ); 
		...
		timer1 = new Timer( 1, new ActionListener()
		{
			...
			{			
				...
				{								
					...
					JOptionPane.showMessageDialog( Level_9.this, "You beat the last level!\nYour final score is " + score + ".",
						"Winning", JOptionPane.PLAIN_MESSAGE );	
					
					if( score > saveFile.getBottomScore3() )
					{
						JOptionPane.showMessageDialog( Level_9.this, "Congradulations. You made on the high scores list!",
							"Winning", JOptionPane.PLAIN_MESSAGE );
							
						EnterName name = new EnterName( 3, score );
						name.setDefaultCloseOperation( JFrame.EXIT_ON_CLOSE );
						
					}
					else if( score <= saveFile.getBottomScore3() )
					{
						JOptionPane.showMessageDialog( Level_9.this, "Sorry, you did not make the high scores list.",
							"Winning", JOptionPane.PLAIN_MESSAGE );
					}
				...
				{			
					...
					JOptionPane.showMessageDialog( Level_9.this, "You did not reach the goal in the time limit. You lose.",
